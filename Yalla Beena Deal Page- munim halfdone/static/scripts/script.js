...
newOffers.forEach(offer => {
    ...
    offerDiv.innerHTML = `
        ...
        <div class="">
            <p class="mb-0">Offer price: <span class="offer">${offer.offerPrice}</span> <span class="">(For the device inside the display)</span></p>
            <p class="">The original price: <span class="">${offer.originalPrice}</span></p>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-center mt-2 mb-3">
            ...
            <p class=" mb-0">Number of devices reserved within the offer (${offer.reservedDevices}) - remaining (${offer.remaining})</p>
        </div>
...
// Loop through each offer in the 'newOffers' array
